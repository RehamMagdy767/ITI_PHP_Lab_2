...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($db->connect())
    {
      ...
      $columns = "Name, Email,Password,ConfirmPassword, RoomNumber,ProfilePicture";
      $values = "'$name', '$email', ' $password', '$confirmPassword', '$roomNumber', '$profilePicture'";
    if ($db->insert("User", $columns, $values)) 
    {
...
<body>
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <br>
        <div>
            <input type="submit" name="submit" value="Submit" class="b">
